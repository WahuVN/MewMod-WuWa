...
<p align="center">
  <a href="https://github.com/WahuVN/MewMod-WuWa/releases"><img src="https://img.shields.io/badge/Bản_mới_nhất-v1.0.0-38bdf8?style=flat-square" alt="Version"></a>
...
1. Tải bản mới nhất **`ResonaMod-v1.0.0-Standalone.zip`** tại mục **[Releases](https://github.com/WahuVN/MewMod-WuWa/releases)**.
...
git clone https://github.com/WahuVN/MewMod-WuWa.git
cd MewMod-WuWa
...
* **Báo lỗi / Góp ý**: [Mở Issue trên GitHub](https://github.com/WahuVN/MewMod-WuWa/issues)
